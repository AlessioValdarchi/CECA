      ...
      <div className="w-full h-max flex justify-center items-start">
        <div>
          <div className="w-full flex justify-center">
            {' '}
            <button className="bg-ceca-color-button-color rounded-full w-4/5 h-10 text-ceca-color-login-background font-semibold" onClick={() => navigate('/login')}>Accedi</button>
            {' '}
          </div>
          <p className="text-center text-ceca-color-button-color mt-2">
            Don't have an account? 
            <span className="font-semibold" onClick={() => navigate('/signup')}> Sign Up</span>
          </p>
        </div>
